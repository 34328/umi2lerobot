...
class ArgsConfig:
    ...
    # 数据路径相关
    raw_dir: Path = Path("/home/unitree/桌面/umi2lerobot/rawData/UMI on Legs/pushing_2024_05_29_huy.zarr.zip")
    """原始 zarr 文件路径或目录"""
    
    project: str = "UMI on Legs"
    """项目名称 - 用于组织数据集"""
    ...
    # 文本表述 
    text: str = "Push the kettlebell forward"
    """人类指令"""
