"""
LEGATO HDF5 to LeRobot 格式转换脚本 - 真实数据

用于将 LEGATO 真实采集数据集的 HDF5 格式转换为 LeRobot 格式。
...
class ArgsConfig:
    ...
    # 数据路径相关
    raw_dir: Path = Path("/home/unitree/桌面/umi2lerobot/rawData/LEGATO/closing_the_lid_real.hdf5")
    """原始 HDF5 文件路径"""
    
    project: str = "LEGATO"
    """项目名称"""
    
    subtask: str = "closing_the_lid_real"
    """子任务名称"""
    
    robot_type: str = "LEGATO_REAL"
    """机器人类型"""
    
    text: str = "closing the lid"
    """任务描述"""
